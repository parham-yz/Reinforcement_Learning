...
class Agent():
	def __init__(self,action_space) -> None:
		...
		self.mainNet = DQN(IMAGESIZE,action_space.n).to(self.device)
		self.targetNet = DQN(IMAGESIZE,action_space.n).to(self.device)
	...
	def saveKnowlage(self,path):
		torch.save(jimi.mainNet.state_dict(),path)
